...
public class Main {
    ...
    private static void inputNumber() {
        ...
        System.out.println("Informe a coluna onde o número será inserido (0-8): ");
        var col = runUnitGetValidNumber(0, 8);

        // CORREÇÃO: Texto alterado de "coluna" para "linha"
        System.out.println("Informe a linha onde o número será inserido (0-8): ");
        var row = runUnitGetValidNumber(0, 8);

        System.out.printf("Informe o número que vai entrar na posição [%s,%s]\n", col, row);
        var value = runUnitGetValidNumber(1, 9);

        // Passamos (col, row, value)
    ...
    private static void removerNumber() {
        ...
        var col = runUnitGetValidNumber(0, 8);
        System.out.println("Informe a linha (0-8): "); // CORREÇÃO: Texto
        var row = runUnitGetValidNumber(0, 8);
    ...
    private static void showCurrentGame() {
        ...
        // CORREÇÃO: Array de 81 posições (9x9)
        var args = new Object[81];
        var argPos = 0;

        // CORREÇÃO: Loop i e j vão até 9 (BOARD_LIMIT)
        for (int i = 0; i < BOARD_LIMIT; i++) {
            for (int j = 0; j < BOARD_LIMIT; j++) {
